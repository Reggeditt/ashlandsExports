...
const AboutBanner = () => {
  return (
    <div className="relative flex justify-center items-center relative bg-cover bg-center h-96" style={{ backgroundImage: "url('/images/logo.png')", backgroundSize: 'contain' }}>
